...
This project presents an Edge AI-based Road Anomaly Detection System designed to detect and log road irregularities such as potholes, stones, cracks in real time. The system integrates object detection, temporal validation, risk scoring, and heatmap visualization to enhance road safety and driver awareness.
